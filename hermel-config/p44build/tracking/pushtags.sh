...
pushd hermeld
git tag -f HERMEL/0.2/leth-omega2 d0cec9a850880215e9210bed28f7bfbbd5fb233c
git push -f origin HERMEL/0.2/leth-omega2
popd
git clone --depth 1 --no-checkout --single-branch --branch HEAD https://github.com/OnionIoT/omega2-ctrl.git omega2-ctrl
pushd omega2-ctrl
git tag -f HERMEL/0.2/leth-omega2 fa0425d861abbcc34bacd6edc3c7b531ad32c4d9
git push -f origin HERMEL/0.2/leth-omega2
popd
popd
