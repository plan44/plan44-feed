...
pushd hermeld
git tag -f HERMEL/0.1/leth-omega2 3633cb5ad2ae73bf9818d926a0d85dd4c84318f5
git push -f origin HERMEL/0.1/leth-omega2
popd
git clone --depth 1 --no-checkout --single-branch --branch HEAD https://github.com/OnionIoT/omega2-ctrl.git omega2-ctrl
pushd omega2-ctrl
git tag -f HERMEL/0.1/leth-omega2 fa0425d861abbcc34bacd6edc3c7b531ad32c4d9
git push -f origin HERMEL/0.1/leth-omega2
popd
popd
