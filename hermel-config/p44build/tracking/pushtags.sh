...
pushd hermeld
git tag -f HERMEL/1.94/leth-omega2 320d7c7d0dd81650936cf1822d62d32718e5e891
git push -f origin HERMEL/1.94/leth-omega2
popd
git clone --depth 1 --no-checkout --single-branch --branch HEAD https://github.com/OnionIoT/omega2-ctrl.git omega2-ctrl
pushd omega2-ctrl
git tag -f HERMEL/1.94/leth-omega2 fa0425d861abbcc34bacd6edc3c7b531ad32c4d9
git push -f origin HERMEL/1.94/leth-omega2
popd
popd
