...
pushd p44banditd
git tag -f P44BANDIT/0.6/p44bandit-omega2 554a2eb5c11d3f1b8a8a0e276a97939a9c062ff7
git push -f origin P44BANDIT/0.6/p44bandit-omega2
popd
git clone --depth 1 --no-checkout --single-branch --branch HEAD https://github.com/OnionIoT/omega2-ctrl.git omega2-ctrl
pushd omega2-ctrl
git tag -f P44BANDIT/0.6/p44bandit-omega2 fa0425d861abbcc34bacd6edc3c7b531ad32c4d9
git push -f origin P44BANDIT/0.6/p44bandit-omega2
popd
popd
