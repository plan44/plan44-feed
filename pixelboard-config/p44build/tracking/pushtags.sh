...
pushd pixelboardd
git tag pixelboard-omega2_0.13 dfd1824b49767f4e06c3884d20bf83817c72be92
git push origin pixelboard-omega2_0.13
popd
git clone --depth 1 --no-checkout --single-branch --branch ow_testing ssh://plan44@plan44.ch/home/plan44/sharedgit/mg44.git mg44
pushd mg44
git tag pixelboard-omega2_0.13 002b1e8408c823317afa9ed10508d3b35af24ce5
git push origin pixelboard-omega2_0.13
popd
...
pushd serialfwd
git tag pixelboard-omega2_0.13 e198c8ec40a31b6e39687125efa159950f55e3e5
git push origin pixelboard-omega2_0.13
popd
git clone --depth 1 --no-checkout --single-branch --branch HEAD git@github.com:OnionIoT/omega2-ctrl.git omega2-ctrl
pushd omega2-ctrl
git tag pixelboard-omega2_0.13 fa0425d861abbcc34bacd6edc3c7b531ad32c4d9
git push origin pixelboard-omega2_0.13
popd
popd
