...
pushd lethd
git tag -f LETH/1.5/leth-omega2 dbffcf921b532f1f6554f74a1fe3046eae5e2ef9
git push -f origin LETH/1.5/leth-omega2
popd
git clone --depth 1 --no-checkout --single-branch --branch HEAD https://github.com/OnionIoT/omega2-ctrl.git omega2-ctrl
pushd omega2-ctrl
git tag -f LETH/1.5/leth-omega2 fa0425d861abbcc34bacd6edc3c7b531ad32c4d9
git push -f origin LETH/1.5/leth-omega2
popd
popd
