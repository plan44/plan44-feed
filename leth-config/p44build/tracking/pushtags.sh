...
pushd mg44
git tag -f LETH/0.5/leth-omega2 6df3c33a2d0911f67fe1cf2313aa8cd79a74546e
git push -f origin LETH/0.5/leth-omega2
popd
git clone --depth 1 --no-checkout --single-branch --branch master https://github.com/plan44/lethd.git lethd
pushd lethd
git tag -f LETH/0.5/leth-omega2 012a626d440f258ecf24b2a1a09461e910f374cc
git push -f origin LETH/0.5/leth-omega2
popd
git clone --depth 1 --no-checkout --single-branch --branch HEAD https://github.com/OnionIoT/omega2-ctrl.git omega2-ctrl
pushd omega2-ctrl
git tag -f LETH/0.5/leth-omega2 fa0425d861abbcc34bacd6edc3c7b531ad32c4d9
git push -f origin LETH/0.5/leth-omega2
popd
popd
